...
face_swapper_model: str = 'InSwapper 128' # ['inswapper_128', 'inswapper_128_fp16', 'inswapper_256', 'simswap_256', 'simswap_512_unofficial', 'simswap_uniface_1.1']
face_enhancer_model: str = 'GFPGAN' # ['codeformer', 'dmdnet', 'gfpgan_1.2', 'gfpgan_1.3', 'gfpgan_1.4', 'gpen_bfr_256', 'gpen_bfr_512', 'restoreformer_plus_plus']
similarity_threshold: float = 0.65
blend_ratio: float = 0.75
face_swap_mode = "first" # Swap the first detected face
no_face_action = 0 # Use untouched original frame
