...
def run_ffmpeg(globals, args: List[str]) -> bool:
    commands = ['ffmpeg', '-hide_banner', '-hwaccel', 'auto', '-y', '-loglevel', globals.log_level]
...
def cut_video(globals, original_video: str, cut_video: str, start_frame: int, end_frame: int, reencode: bool):
...
def extract_frames(globals, target_path : str, trim_frame_start, trim_frame_end, fps : float) -> bool:
